...
(() => {
    var __webpack_modules__ = {
        3894: (t, e, n) => {
            "use strict";
            n.d(e, {Z: () => p});
            var o = n(5785), i = n(5671), r = n(3144), a = n(9340), s = n(3930), c = n(1120);
            ...
            var p = function (t) {
                ...
                return (0, r.Z)(p, [{
                    ...
                    key: "getHighlightIds", value: function () {
                        return this.options.parent ? this.store.getChildrenDeep({id: this.options.parent}).map((function (t) {
                            return t.id
                        })) : this.options.single_object ? this.store.getChildrenDeep({id: this.options.id}).map((function (t) {
                            return t.id
                        })) : [this.options.id]
                    }
                }, {
                    ...
                    key: "getRect", value: function () {
                        var t, e = [], n = l(this.store.getChildrenDeep({id: this.options.id}));
                        try {
                            for (n.s(); !(t = n.n()).done;) {
                                var i = t.value;
                        ...
                        var r = Math.min.apply(Math, (0, o.Z)(e.map((function (t) {
                            return t.x
                        })))), a = Math.min.apply(Math, (0, o.Z)(e.map((function (t) {
                            return t.y
                        }))));
                        return {
                            x: r, y: a, width: Math.max.apply(Math, (0, o.Z)(e.map((function (t) {
                                return t.x + t.width
                            })))) - r, height: Math.max.apply(Math, (0, o.Z)(e.map((function (t) {
                                return t.y + t.height
                            })))) - a
                        }
                    }
            ...
            var o = n(5671), i = n(3144), r = n(144), a = function () {
                ...
                return (0, i.Z)(t, [{
                    ...
                    key: "createCSSRules", value: function () {
                        return ""
                    }
                }, {
                    key: "createStyleExceptions", value: function () {
                        var t = "";
                    ...
                    key: "createImageBackgroundElement", value: function () {
                    ...
                    key: "applyElementAttributes", value: function () {
                        this.options.parent_id && this.store.getObject({id: this.options.parent_id}).static && (this.options.static = !0), this.options.static && this.element.classList.add("imp-object-static"), this.element.classList.add("imp-object"), this.element.setAttribute("data-object-id", this.options.id), this.options.parent_id && this.element.setAttribute("data-parent-id", this.options.parent_id), this.element.setAttribute("data-title", this.options.title), this.element.setAttribute("data-image-map-id", this.store.getID())
                    }
                }, {
                    key: "applyPageloadClass", value: function () {
                        "grow" === this.store.state.objectConfig.pageload_animation && this.element.classList.add("imp-pageload-animation-grow"), "fade" === this.store.state.objectConfig.pageload_animation && this.element.classList.add("imp-pageload-animation-fade-in"), "fall-down" === this.store.state.objectConfig.pageload_animation && this.element.classList.add("imp-pageload-animation-fall-down")
                    }
                }, {
                    key: "getHighlightIds", value: function () {
                        return this.options.parent_id ? this.store.getChildrenDeep({id: this.options.parent_id}).map((function (t) {
                            return t.id
                        })) : [this.options.id]
                    }
                }, {
                    ...
                    key: "stopGlowing", value: function () {
            ...
            "use strict";
            n.d(e, {Z: () => d});
            var o = n(5671), i = n(3144), r = n(9340), a = n(3930), s = n(1120), c = n(144), l = n(9867), u = n(9997);
            ...
            "use strict";
            n.d(e, {Z: () => u});
            var o = n(5671), i = n(3144), r = n(9340), a = n(3930), s = n(1120), c = n(9997);
            ...
            var u = function (t) {
                ...
                return (0, i.Z)(p, [{
                    key: "createElement", value: function () {
                        for (var t = this.store.getArtboard().width, e = this.store.getArtboard().height, n = t * (this.options.x / 100), o = e * (this.options.y / 100), i = t * (this.options.width / 100), r = e * (this.options.height / 100), a = document.createElementNS("http://www.w3.org/2000/svg", "polygon"), s = "", c = 0; c < this.options.points.length; c++) {
            ...
            "use strict";
            n.d(e, {Z: () => p});
            var o = n(5671), i = n(3144), r = n(9340), a = n(3930), s = n(1120), c = n(9867), l = n(9997);
                ...
                return (0, i.Z)(p, [{
                    key: "createElement", value: function () {
                        ...
                        if (t.classList.add("imp-object-spot"), this.options.default_style.use_icon) {
                            ...
                            if ("custom" === this.options.default_style.icon_type && this.options.default_style.icon_url.length > 0) {
                                var n = '<img src="'.concat(this.options.default_style.icon_url, '" style="width: ').concat(this.options.default_style.icon_size, "px; height: ").concat(this.options.default_style.icon_size, 'px">');
                    ...
                    key: "createCSSRules", value: function (t) {
                        ...
                        if (e += "left: ".concat(this.options.x, "%;"), e += "top: ".concat(this.options.y, "%;"), this.options.default_style.use_icon) {
                            ...
                            var o, i;
                            o = -this.options.default_style.icon_size / 2, i = this.options.default_style.icon_is_pin ? -this.options.default_style.icon_size : -this.options.default_style.icon_size / 2, e += "margin-top: ".concat(i, "px;"), e += "margin-left: ".concat(o, "px;"), this.options.default_style.icon_is_pin ? e += "transform-origin: 50% 100%;" : e += "transform-origin: 50% 50%;"
                        }
                        if (!this.options.default_style.use_icon) {
                            ...
                            e += "opacity: ".concat(t.opacity, ";"), e += "border-radius: ".concat(t.border_radius, "px;"), e += "background: rgba(".concat(r.r, ", ").concat(r.g, ", ").concat(r.b, ", ").concat(t.background_opacity, ");"), e += "border-width: ".concat(t.border_width, "px;"), e += "border-style: ".concat(t.border_style, ";"), e += "border-color: rgba(".concat(a.r, ", ").concat(a.g, ", ").concat(a.b, ", ").concat(t.border_opacity, ");"), e += "margin-top: ".concat(-this.options.width / 2, "px;"), e += "margin-left: ".concat(-this.options.height / 2, "px;")
                        }
                        e += "filter: ";
            ...
            "use strict";
            n.d(e, {Z: () => u});
            var o = n(5671), i = n(3144), r = n(9340), a = n(3930), s = n(1120);
            ...
            var u = function (t) {
                ...
                return (0, i.Z)(u, [{
                    key: "createElement", value: function () {
                        var t, e = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
            ...
            var u = function (t) {
                ...
                return (0, i.Z)(u, [{
                    ...
                    key: "createCSSRules", value: function (t) {
                        var e = "";
                        e += "left: ".concat(this.options.x, "%;"), e += "top: ".concat(this.options.y, "%;"), e += "width: ".concat(this.options.width, "%;"), e += "height: ".concat(this.options.height, "%;"), e += "opacity: ".concat(t.opacity, ";"), e += "filter: ";
                        var n, o = c(t.filters);
                        try {
                            for (o.s(); !(n = o.n()).done;) {
                                var i = n.value;
            ...
            var u = function (t) {
                ...
                return (0, i.Z)(p, [{
                    ...
                    key: "createCSSRules", value: function (t) {
                        var e = "", n = (0, c.oo)(this.options.text.text_color);
                        e += "left: " + this.options.x + "%;", e += "top: " + this.options.y + "%;", e += "font-family: " + this.options.text.font_family + ";", e += "font-size: " + this.options.text.font_size + "px;", e += "font-weight: " + this.options.text.font_weight + ";", e += "color: rgba(" + n.r + ", " + n.g + ", " + n.b + ", " + this.options.text.text_opacity + ");", e += "filter: ";
            ...
            var o = "RECT_CANVAS_WRAP", i = "RECT_NAVIGATOR", r = "RECT_TOOLTIPS_CONTAINER", a = "RECT_MENU",
                s = "RECT_BUTTON_FULLSCREEN", c = "RECT_BUTTON_ZOOM_IN", l = "RECT_BUTTON_ZOOM_OUT",
                u = "RECT_ARTBOARD_SELECT_MENU", p = "RECT_BUTTON_OPEN_MENU", d = "RECT_BUTTON_CLOSE_MENU",
                h = "RECT_OPENED_FULLSCREEN_TOOLTIP", m = "ACTION_IDLE", f = "ACTION_PAN", g = "ACTION_PINCH",
                b = "ACTION_PAN_ON_NAVIGATOR", v = "UP", y = "DOWN", _ = "LEFT", w = "RIGHT", x = "mapInit",
                k = "objectHighlight", j = "objectUnhighlight", M = "objectClick", I = "tooltipShow", C = "tooltipHide",
                E = "artboardChange"
            ...
            var ObjectController = function () {
                ...
                return (0, _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_7__.Z)(ObjectController, [{
                    key: "insertObjects",
                    value: function () {
                        this.emptyContainers(), this.fillContainers(), this.generateStylesheet(), this.animateObjects(500)
                    }
                }, {
                    key: "handleAction", value: function (t) {
                        if ("zoomUpdate" === t.type && this.store.state.objectConfig.scale_spots) {
                            var e, n = _createForOfIteratorHelper(this.spots);
                            try {
                                for (n.s(); !(e = n.n()).done;) {
                                    var o = e.value;
                    ...
                    key: "createObjects", value: function () {
                        this.objects = {}, this.spots = [], this.highlightedObjects = new Set;
                        var t, e = _createForOfIteratorHelper(this.store.getObjects());
                        try {
                            for (e.s(); !(t = e.n()).done;) {
                                var n = t.value;
                                switch (n.type) {
                    ...
                    key: "emptyContainers", value: function () {
                        for (; this.container.firstChild;) this.container.removeChild(this.container.lastChild)
                    }
                }, {
                    key: "generateStylesheet", value: function () {
                        var t = "";
                        for (var e in this.objects) t += this.objects[e].styles;
                        if (this.store.state.objectConfig.glowing_objects) {
                            var n = (0, Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_0__.oo)(this.store.state.objectConfig.glowing_objects_color) || {
                                r: 255,
                                b: 255,
                                g: 255
                            };
                            t += "@keyframes ObjectGlowAnimation {", t += "  0% {", t += "    filter: drop-shadow(0 0 20px rgba(".concat(n.r, ", ").concat(n.g, ", ").concat(n.b, ", ").concat(this.store.state.objectConfig.glow_opacity, "));"), t += "  }", t += "  50% {", t += "    filter: drop-shadow(0 0 20px rgba(".concat(n.r, ", ").concat(n.g, ", ").concat(n.b, ", 0));"), t += "  }", t += "  100% {", t += "    filter: drop-shadow(0 0 20px rgba(".concat(n.r, ", ").concat(n.g, ", ").concat(n.b, ", ").concat(this.store.state.objectConfig.glow_opacity, "));"), t += "  }", t += "}"
                        }
                    ...
                    key: "animateObjects", value: function () {
                        ...
                        if ("none" !== this.store.state.objectConfig.pageload_animation) {
                            ...
                            this.store.getObjects().length > 20 && (n = 1500 / this.store.getObjects().length), Object.keys(this.objects).forEach((function (e) {
                    ...
                    key: "animateObject", value: function (t, e) {
                        var n = this;
                        if (t.options.type !== Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.WW || t.options.single_object) {
                            var o = 0;
                            setTimeout((function () {
                                "fade" === n.store.state.objectConfig.pageload_animation && (t.element.style.opacity = t.options.default_style.opacity, setTimeout((function () {
                                    t.element.classList.remove("imp-object-pageload-animation"), t.element.setAttribute("style", "")
                                }), 500)), "grow" === n.store.state.objectConfig.pageload_animation && (t.element.style.opacity = t.options.default_style.opacity, t.element.style.transform = "scale(1)", setTimeout((function () {
                                    t.element.classList.remove("imp-object-pageload-animation"), t.element.setAttribute("style", "")
                                }), 500)), "fall-down" === n.store.state.objectConfig.pageload_animation && (t.element.style.opacity = t.options.default_style.opacity, t.element.style.transitionProperty = "opacity", setTimeout((function () {
                                    t.element.classList.remove("imp-object-pageload-animation"), t.element.setAttribute("style", "")
                                }), 2e3), i()), "flash" === n.store.state.objectConfig.pageload_animation && (n.highlightObject(t.options.id), setTimeout((function () {
                                    n.unhighlightObject(t.options.id), setTimeout((function () {
                    ...
                    key: "highlightObject", value: function (t) {
                        ...
                        return new Promise((function (n) {
                            e.store.state.objectConfig.glowing_objects && e.store.state.objectConfig.stop_glowing_on_mouseover && !e.didStopGlowing && (e.didStopGlowing = !0, e.container.classList.remove("imp-glowing-objects")), e.objects[t] && (e.objects[t].options.type !== Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.WW || e.objects[t].options.single_object) && (e.objects[t].getHighlightIds().forEach((function (t) {
                                e.objects[t].highlight(), e.highlightedObjects.add(t)
                            })), ImageMapPro.trigger({
                                type: Client_consts__WEBPACK_IMPORTED_MODULE_12__.Y7,
                                payload: {map: e.store.state.general.name, object: e.objects[t].options.title}
                            }), requestAnimationFrame(n))
                        }))
                    }
                }, {
                    key: "unhighlightObject", value: function (t) {
                        var e = this;
                        return new Promise((function (n) {
                    ...
                    key: "unhighlightAllObjects", value: function () {
                        var t = this;
                        return new Promise((function (e) {
                            var n, o = _createForOfIteratorHelper(t.highlightedObjects);
                            try {
                                for (o.s(); !(n = o.n()).done;) {
                                    var i = n.value;
                    ...
                    key: "getFocusObjectCoordsAndZoom", value: function (t) {
                        if (t = this.store.getObject({id: t}).parent || t, 1 == this.store.getMaxZoom()) return {
                            zoom: 1,
                            pan: {x: 0, y: 0}
                        };
                        var e = this.objects[t].getRect(), n = e.x + e.width / 2, o = e.y + e.height / 2,
                            i = e.width > e.height ? 50 / e.width : 50 / e.height;
                        return i < 1 && (i = 1), i > this.store.getMaxZoom() && (i = this.store.getMaxZoom()), {
                            zoom: i,
                            pan: {
                    ...
                    key: "performClickAction", value: function performClickAction(id) {
                        id = this.store.getObject({id}).parent || id, this.objects[id] && ("follow-link" === this.objects[id].options.actions.click && (document.querySelector("#imp-temp-link") || document.body.appendChild((0, Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_0__.Bv)('<a href="" id="imp-temp-link" target="_blank"></a>')), document.querySelector("#imp-temp-link").setAttribute("href", this.objects[id].options.actions.link), this.objects[id].options.actions.open_link_in_new_window ? document.querySelector("#imp-temp-link").setAttribute("target", "_blank") : document.querySelector("#imp-temp-link").removeAttribute("target"), document.querySelector("#imp-temp-link").click()), "run-script" === this.objects[id].options.actions.click && eval(this.objects[id].options.actions.script.replace("<br>", "")), "change-artboard" === this.objects[id].options.actions.click && this.store.dispatch("changeArtboard", {
                            artboardId: this.objects[id].options.actions.artboard,
                            zoomOut: !0
                        }), ImageMapPro.trigger({
                            type: Client_consts__WEBPACK_IMPORTED_MODULE_12__.x4,
                            payload: {map: this.store.state.general.name, object: this.objects[id].options.title}
                        }))
                    }
                }]), ObjectController
            }()
            ...
            var o = "artboard", i = "spot", r = "rect", a = "oval", s = "poly", c = "text", l = "svg", u = "svg-single",
                p = "group"
        }, 9997: (t, e, n) => {
            "use strict";
            n.d(e, {
            ...
            var o = n(1002), i = function () {
                ...
                var e = 0, n = 0, o = 0;
                4 == t.length ? (e = "0x" + t[1] + t[1], n = "0x" + t[2] + t[2], o = "0x" + t[3] + t[3]) : 7 == t.length && (e = "0x" + t[1] + t[2], n = "0x" + t[3] + t[4], o = "0x" + t[5] + t[6]), e /= 255, n /= 255, o /= 255;
                var i = Math.min(e, n, o), r = Math.max(e, n, o), a = r - i, s = 0, c = 0;
                return s = 0 == a ? 0 : r == e ? (n - o) / a % 6 : r == n ? (o - e) / a + 2 : (e - n) / a + 4, (s = Math.round(60 * s)) < 0 && (s += 360), c = (r + i) / 2, {
                    h: s,
                ...
                if ("[object String]" == Object.prototype.toString.call(t) && (t = document.querySelector(t)), t) return {
                ...
                if ("touchstart" === t.type || "touchmove" === t.type || "touchend" === t.type || "touchcancel" === t.type) {
                    ...
                    e = o.pageX, n = o.pageY
                } else "mousedown" !== t.type && "mouseup" !== t.type && "mousemove" !== t.type && "mouseover" !== t.type && "mouseout" !== t.type && "mouseenter" !== t.type && "mouseleave" !== t.type && "wheel" !== t.type || (e = t.pageX, n = t.pageY);
                return {x: e, y: n}
            }, d = function (t) {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "1.0.0",
                    ...
                    n = arguments.length > 2 ? arguments[2] : void 0, o = n && n.lexicographical, i = n && n.zeroExtend,
                    r = t.split("."), a = e.split(".");
            ...
            function f(t, e, n) {
                for (var o = !1, i = 0, r = n.length - 1; i < n.length; r = i++) {
                    var a = n[i][0], s = n[i][1], c = n[r][0], l = n[r][1];
            ...
            "use strict";
            n.d(e, {Z: () => s});
            var o = n(8081), i = n.n(o), r = n(3645), a = n.n(r)()(i());
            ...
            "use strict";
            n.d(e, {Z: () => E});
            var o = n(8081), i = n.n(o), r = n(3645), a = n.n(r), s = n(6923), c = n(9494), l = n(9798), u = n(3207),
                p = n(1626), d = n(5515), h = n(3442), m = n(9477), f = n(2668), g = n(8353), b = n(3743), v = n(130),
                y = n(4285), _ = n(6750), w = n(7348), x = n(914), k = n(7486), j = n(1121), M = n(1650), I = n(115),
                C = a()(i());
            ...
            function n(t) {
                for (var n = -1, o = 0; o < e.length; o++) if (e[o].identifier === t) {
                    n = o;
                    break
                }
                return n
            ...
            function o(t, o) {
                for (var r = {}, a = [], s = 0; s < t.length; s++) {
                    var c = t[s], l = o.base ? c[0] + o.base : c[0], u = r[l] || 0, p = "".concat(l, " ").concat(u);
                    r[l] = u + 1;
                    var d = n(p), h = {css: c[1], media: c[2], sourceMap: c[3], supports: c[4], layer: c[5]};
                    if (-1 !== d) e[d].references++, e[d].updater(h); else {
                        var m = i(h, o);
            ...
            function i() {
                ...
                function d(t, e, n, o) {
                    var i = e && e.prototype instanceof f ? e : f, r = Object.create(i.prototype), s = new E(o || []);
                ...
                function M(t, e) {
                    ...
                    if (void 0 === o) return e.delegate = null, "throw" === n && t.iterator.return && (e.method = "return", e.arg = void 0, M(t, e), "throw" === e.method) || "return" !== n && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + n + "' method")), m;
                    var i = h(o, t.iterator, e.arg);
                    if ("throw" === i.type) return e.method = "throw", e.arg = i.arg, e.delegate = null, m;
                    var r = i.arg;
                    return r ? r.done ? (e[t.resultName] = r.value, e.next = t.nextLoc, "return" !== e.method && (e.method = "next", e.arg = void 0), e.delegate = null, m) : r : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, m)
                }
                ...
                return g.prototype = b, a(w, "constructor", {
                    value: b,
                    configurable: !0
                }), a(b, "constructor", {
                    value: g,
                    configurable: !0
                }), g.displayName = p(b, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) {
                    ...
                    return {__await: t}
                }, x(k.prototype), p(k.prototype, l, (function () {
                    return this
                })), e.AsyncIterator = k, e.async = function (t, n, o, i, r) {
                    void 0 === r && (r = Promise);
                    var a = new k(d(t, n, o, i), r);
                    return e.isGeneratorFunction(n) ? a : a.next().then((function (t) {
                        return t.done ? t.value : a.next()
                    }))
                }, x(w), p(w, u, "Generator"), p(w, c, (function () {
                    return this
                    ...
                    constructor: E, reset: function (t) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(C), !t) for (var e in this) "t" === e.charAt(0) && r.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = void 0)
                    }, stop: function () {
                        this.done = !0;
    ...
    }, __webpack_require__.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), __webpack_require__.nc = void 0;
    var __webpack_exports__ = {};
    (() => {
        "use strict";
        var t = __webpack_require__(3379), e = __webpack_require__.n(t), n = __webpack_require__(7795),
            o = __webpack_require__.n(n), i = __webpack_require__(569), r = __webpack_require__.n(i),
            a = __webpack_require__(3565), s = __webpack_require__.n(a), c = __webpack_require__(9216),
            l = __webpack_require__.n(c), u = __webpack_require__(4589), p = __webpack_require__.n(u),
            d = __webpack_require__(779), h = {};
        ...
        var m = __webpack_require__(9997), f = {};
        ...
        var g = __webpack_require__(4957), b = void 0;
        ...
        function O() {
            return O = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 13:
                            j({
                                name: "highlightObject", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.abrupt("return", new Promise(function () {
                                                        var t = y(w().mark((function t(e) {
                                                            return w().wrap((function (t) {
                                                                for (; ;) switch (t.prev = t.next) {
                                                                    case 0:
                                                                        return t.next = 2, i.store.dispatch("highlightObject", {
                                                                            objectId: r.id,
                                                                            showTooltip: !1,
                                                                            hideAllTooltips: !1
                                                                        });
            ...
            return P = y(w().mark((function t() {
                ...
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        ...
                        case 4:
                            j({
                                name: "unhighlightAllObjects", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
        ...
        function z() {
            return z = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function R() {
            return R = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 13:
                            j({
                                name: "unhighlightObject", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
        ...
        function B() {
            return B = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 13:
                            j({
                                name: "showTooltip", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
            ...
            return D = y(w().mark((function t() {
                ...
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        ...
                        case 4:
                            j({
                                name: "hideAllTooltips", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
        ...
        function q() {
            return q = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 13:
                            j({
                                name: "hideTooltip", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
        ...
        function Y() {
            return Y = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                                                    ...
                                                    return t.abrupt("return", new Promise(function () {
                                                        var t = y(w().mark((function t(e) {
                                                            return w().wrap((function (t) {
                                                                for (; ;) switch (t.prev = t.next) {
                                                                    case 0:
                                                                        return t.next = 2, i.store.dispatch("showTooltip", {
                                                                            objectId: r.id,
                                                                            showTooltip: !1,
                                                                            hideAllTooltips: !1
                                                                        });
        ...
        function X() {
            return X = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function V() {
            return V = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function tt() {
            return tt = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function nt() {
            return nt = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function it() {
            return it = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function at() {
            return at = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 13:
                            j({
                                name: "focusObject", action: function () {
                                    var t = y(w().mark((function t() {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.abrupt("return", new Promise(function () {
                                                        var t = y(w().mark((function t(e) {
                                                            return w().wrap((function (t) {
                                                                for (; ;) switch (t.prev = t.next) {
                                                                    case 0:
                                                                        return t.next = 2, i.store.dispatch("focusObject", {
                                                                            objectId: r.id,
                                                                            showTooltip: !1
                                                                        });
                                                                    case 2:
        ...
        function ct() {
            return ct = y(w().mark((function t(e) {
                var n, o, i, r, a;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        function ut() {
            return (ut = y(w().mark((function t(e) {
                var n, o, i, r;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
        ...
        window.ImageMapPro.highlightObject = function () {
                                                    ...
                                                    return t.abrupt("return", new Promise(function () {
                                                        var t = y(w().mark((function t(e) {
                                                            return w().wrap((function (t) {
                                                                for (; ;) switch (t.prev = t.next) {
                                                                    case 0:
                                                                        return t.next = 2, o.store.dispatch("highlightObject", {
                                                                            objectId: i.id,
                                                                            showTooltip: !1,
                                                                            hideAllTooltips: !1
                                                                        });
                                                    ...
                                                    return t.abrupt("return", new Promise(function () {
                                                        var t = y(w().mark((function t(e) {
                                                            return w().wrap((function (t) {
                                                                for (; ;) switch (t.prev = t.next) {
                                                                    case 0:
                                                                        return t.next = 2, o.store.dispatch("focusObject", {
                                                                            objectId: i.id,
                                                                            showTooltip: !1
                                                                        });
                                                                    case 2:
            ...
            if (!n) return !1;
            var o, i = n.store.getArtboardByTitle({title: e});
            if (!i) return !1;
            j({
                name: "changeArtboard", action: (o = y(w().mark((function t() {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                return t.abrupt("return", new Promise(function () {
                                    var t = y(w().mark((function t(e) {
                                        return w().wrap((function (t) {
                                            for (; ;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.next = 2, n.store.dispatch("changeArtboard", {
                                                        artboardId: i.id,
                                                        zoomOut: !0
                                                    });
                                                case 2:
            ...
            var e, n = ImageMapPro.instances[t];
            if (!n) return !1;
            j({
                name: "zoomIn", action: (e = y(w().mark((function t() {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                return t.abrupt("return", new Promise(function () {
            ...
            if (!n) return !1;
            j({
                name: "zoomOut", action: (e = y(w().mark((function t() {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                return t.abrupt("return", new Promise(function () {
            ...
            if (!n) return !1;
            j({
                name: "flashObjects", action: (e = y(w().mark((function t() {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                return t.abrupt("return", new Promise(function () {
        ...
        }, __webpack_require__(5514), (0, m.Cd)((function () {
            ImageMapPro.subscribe((function (t) {
                "mapInit" == t.type && (document.querySelectorAll("[data-imp-highlight-object-on-mouseover]").forEach((function (t) {
        ...
        var pt = __webpack_require__(5671), dt = __webpack_require__(3144), ht = __webpack_require__(9142);

        function mt(t, e, n) {
            return (e = (0, ht.Z)(e)) in t ? Object.defineProperty(t, e, {
                value: n,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        var gt = function () {
                ...
                return (0, dt.Z)(t, [{
                    ...
                    key: "handleEventStart", value: function (t) {
                        this.updateFlagsAndVariables(t), this.doStartAction(), this.doMenuStart(t)
                    }
                }, {
                    key: "handleEventMove", value: function (t) {
                    ...
                    key: "handleEventEnd", value: (i = y(w().mark((function t(e) {
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                                case 0:
                    ...
                    key: "handleEventKeyDown", value: function (t) {
                        this.updateFlagsAndVariables(t)
                    }
                }, {
                    key: "handleEventKeyUp", value: function (t) {
                        this.updateFlagsAndVariables(t), "Escape" == t.code && this.store.dispatch("closeFullscreen"), document.querySelector('[data-image-map-id="'.concat(this.store.getID(), '"] input:focus')) && this.store.dispatch("updateSearch", {searchString: document.querySelector('[data-image-map-id="'.concat(this.store.getID(), '"] input:focus')).value})
                    }
                }, {
                    key: "handleEventResize", value: function () {
                        this.store.dispatch("beforeResize"), this.store.dispatch("resize")
                    }
                }, {
                    key: "handleEventWheel", value: function (t) {
                        this.updateFlagsAndVariables(t), this.UIRectUnderEvent || this.isEventOverCanvas && this.store.state.zooming.enable_zooming && (this.store.state.zooming.hold_ctrl_to_zoom ? this.mac && this.cmdKeyDown || !this.mac && this.ctrlKeyDown ? this.doZoom(t) : this.store.dispatch("failedToZoom") : this.doZoom(t))
                    }
                }, {
                    key: "handleEventChange", value: function (t) {
                        t.target.classList.contains("imp-ui-layers-select") && t.target.closest('[data-image-map-id="'.concat(this.store.getID(), '"]')) && this.store.dispatch("changeArtboard", {
                    ...
                    key: "updateFlagsAndVariables", value: function (t) {
                        ...
                        }) || this.isEventOverVisibleTooltip(t), this.objectIdUnderEvent = this.getObjectIdUnderEvent(t), "mousedown" != t.type && "touchstart" != t.type || (this.objectIdUnderEventStart = this.objectIdUnderEvent), this.objectIdClicked = this.objectIdUnderEvent === this.objectIdUnderEventStart && this.objectIdUnderEvent, "mousemove" != t.type && "touchmove" != t.type || (this.objectIdUnderEventStart = !1), this.canPinch = this.getCanPinch(t), this.updateStickyTooltipsConfig();
                        var e = this.eventCoordinates.x - this.eventCoordinatesPrevious.x,
                            n = this.eventCoordinates.y - this.eventCoordinatesPrevious.y;
                        e > 0 && Math.abs(e) > Math.abs(n) && (this.eventDirection = g.MJ), e < 0 && Math.abs(e) > Math.abs(n) && (this.eventDirection = g.r4), n > 0 && Math.abs(n) > Math.abs(e) && (this.eventDirection = g.BQ), n < 0 && Math.abs(n) > Math.abs(e) && (this.eventDirection = g.in), this.eventCoordinatesPrevious = function (t) {
                    ...
                    key: "doStartAction", value: function () {
                    ...
                    key: "doAction", value: function (t) {
                        return this.actionStart === g.Nb && (this.action = g.Nb, this.store.dispatch("startPinch", {event: t})), this.actionStart === g.EZ && (this.action = g.EZ), this.actionStart === g.Fq && (this.action = g.Fq, this.store.dispatch("startPan", {
                            x: this.eventCoordinates.x,
                            y: this.eventCoordinates.y
                        })), this.actionStart = g.RN, this.action === g.Nb ? (this.store.dispatch("pinch", {event: t}), this.preventDefault(t), !0) : this.action === g.EZ ? (this.store.dispatch("panOnNavigator", {
                            x: this.eventCoordinates.x,
                            y: this.eventCoordinates.y
                        }), this.preventDefault(t), !0) : this.action === g.Fq && (this.store.dispatch("pan", {
                            x: this.eventCoordinates.x,
                            y: this.eventCoordinates.y
                        }), this.isPanLimitReached() || this.preventDefault(t), !0)
                    }
                }, {
                    key: "doEndAction", value: function () {
                        return this.actionStart = g.RN, this.action == g.Nb ? (this.canPinch || (this.action = g.RN), this.isEventOverCanvas && !this.UIRectUnderEvent && (this.action = g.Fq, this.store.dispatch("startPan", this.eventCoordinates)), !0) : this.action !== g.RN && (this.action = g.RN, !0)
                    }
                }, {
                    key: "doClickUI", value: function (t) {
                        if (this.UIClickedRect) {
                            if (this.UIClickedRect === g.h9 && (this.store.getIsFullscreen() ? this.store.dispatch("closeFullscreen") : this.store.dispatch("goFullscreen")), this.UIClickedRect === g.f9 && this.store.dispatch("zoomIn", {}), this.UIClickedRect === g.s2 && this.store.dispatch("zoomOut", {}), t.target.classList.contains("imp-clear-search") && this.store.dispatch("clearSearch"), this.UIClickedRect == g.db) {
                                if (!(null === t.target.closest(".imp-tooltip-content") && !t.target.classList.contains("imp-tooltip-content") || t.target.closest(".imp-tooltip-close-button") || t.target.classList.contains("imp-tooltip-close-button"))) return !1;
                                this.store.dispatch("closeFullscreenTooltip")
                            }
                            return this.UIClickedRect == g.kK && this.store.dispatch("openMenu"), this.UIClickedRect == g.GO && this.store.dispatch("closeMenu"), this.UIClickedRect == g.d4 ? (this.store.dispatch("unhighlightAllObjects"), !1) : (t.target.closest(".imp-search-box-input-wrap") || (this.store.dispatch("unhighlightAllObjects"), this.preventDefault(t)), !0)
                        }
                        return !1
                    }
                }, {
                    key: "doClickObject", value: (o = y(w().mark((function t() {
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                                case 0:
                                ...
                                case 3:
                                    ...
                                    return t.next = 6, this.store.dispatch("focusObject", {
                                ...
                                case 8:
                                    return this.store.dispatch("highlightObject", {
                                        objectId: this.objectIdUnderEvent,
                                        showTooltip: !0,
                                        hideAllTooltips: !1
                                    }), t.abrupt("return", !0);
                    ...
                    key: "doMouseOverObject", value: (n = y(w().mark((function t(e) {
                        var n;
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                                case 0:
                                ...
                                case 12:
                                    return n = !0, "click" == this.store.state.tooltips.show_tooltips && (n = !1), this.store.dispatch("highlightObject", {
                                        objectId: this.objectIdUnderEvent,
                                        showTooltip: n,
                                        hideAllTooltips: !1
                                    }), t.abrupt("return", !0);
                    ...
                    key: "doMenuStart", value: function (t) {
                        if (this.UIRectUnderEvent !== g.el) return !1
                    }
                }, {
                    key: "doMenuMove", value: function (t) {
                        return this.menuListItemIDUnderEventPrevious !== this.menuListItemIDUnderEvent && (this.menuListItemIDUnderEvent && !(0, m.tq)() ? (this.menuListItemIDUnderEventPrevious = this.menuListItemIDUnderEvent, this.store.dispatch("unhighlightAllObjects"), this.store.getObject({id: this.menuListItemIDUnderEvent}).static || this.store.dispatch("highlightObject", {
                            objectId: this.menuListItemIDUnderEvent,
                            showTooltip: !1
                        }), !0) : !1 === this.menuListItemIDUnderEvent && (this.objectIdUnderEventPrevious = null, this.menuListItemIDUnderEventPrevious = !1, !1))
                    }
                }, {
                    key: "doMenuEnd", value: (e = y(w().mark((function t(e) {
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                                case 0:
                                ...
                                case 12:
                                    ...
                                    return t.next = 16, this.store.dispatch("changeArtboard", {
                                ...
                                case 20:
                                    return t.next = 22, this.store.dispatch("changeArtboard", {
                                ...
                                case 26:
                                    return t.next = 28, this.store.dispatch("highlightObject", {
                                        objectId: this.menuListItemIDUnderEvent,
                                        showTooltip: !0,
                                        hideAllTooltips: !1
                                    });
                    ...
                    key: "doZoom", value: function (t) {
                        var e = this.action != g.Fq;
                        t.deltaY > 0 ? this.store.dispatch("zoomOut", {
                            coords: this.eventCoordinates,
                            animate: e
                        }) : this.store.dispatch("zoomIn", {
                            coords: this.eventCoordinates,
                            animate: e
                        }), this.preventDefault(t), this.action == g.Fq && this.store.dispatch("startPan", this.eventCoordinates)
                    }
                }, {
                    key: "preventDefault", value: function (t) {
                        t.cancelable && t.preventDefault()
                    }
                }, {
                    key: "getUIRectNameUnderEvent", value: function () {
                    ...
                    key: "isPointInsideRect", value: function (t, e) {
                        return !!e && t.x > e.offset.left && t.x < e.offset.left + e.offsetWidth && t.y > e.offset.top && t.y < e.offset.top + e.offsetHeight
                    }
                }, {
                    key: "getObjectIdUnderEvent", value: function (t) {
                        var e, n, o, i, r, a;
                        if (t.target.dataset.parentId ? a = t.target.dataset.parentId : null !== (e = t.target.closest("[data-parent-id]")) && void 0 !== e && e.dataset.parentId ? a = null === (n = t.target.closest("[data-parent-id]")) || void 0 === n ? void 0 : n.dataset.parentId : t.target.dataset.objectId ? a = t.target.dataset.objectId : null !== (o = t.target.closest("[data-object-id]")) && void 0 !== o && o.dataset.objectId && (a = null === (i = t.target.closest("[data-object-id]")) || void 0 === i ? void 0 : i.dataset.objectId), !a) return !1;
                    ...
                    key: "isEventOverVisibleTooltip", value: function (t) {
                        if (t.target.classList.contains("imp-tooltip") || t.target.closest(".imp-tooltip")) return !0
                    }
                }, {
                    key: "getMenuListItemIdUnderEvent", value: function (t) {
                        var e, n, o;
                        return !(!t.target.dataset.listItemId && !(null === (e = t.target.closest("[data-list-item-id]")) || void 0 === e ? void 0 : e.dataset.listItemId)) && (t.target.dataset.imageMapId || (null === (n = t.target.closest("[data-list-item-id]")) || void 0 === n ? void 0 : n.dataset.imageMapId)) === this.store.getID() && (t.target.dataset.listItemId || (null === (o = t.target.closest("[data-list-item-id]")) || void 0 === o ? void 0 : o.dataset.listItemId))
                    }
                }, {
                    key: "getDistanceBetweenCoordinates", value: function (t, e) {
                        return Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2))
                    }
                }, {
                    key: "getZoomedCanvasRect", value: function () {
                        if (this.store.getIsFullscreen()) {
                            var t = 0;
                            return this.store.state.object_list.enable_object_list && !this.store.getIsMenuMobile() && (t = 224), {
                                offset: {
                                    left: 0,
                                    top: window.scrollY
                                }, offsetWidth: window.innerWidth - t, offsetHeight: window.innerHeight
                            }
                        }
                        return this.store.getCanvasWrapRect()
                    }
                }, {
                    key: "getCanPinch", value: function (t) {
                        var e;
                        return !(2 != (null === (e = t.touches) || void 0 === e ? void 0 : e.length) || !this.isPointInsideRect({
                            x: t.touches[0].pageX,
                            y: t.touches[0].pageY
                        }, this.getZoomedCanvasRect()) || !this.isPointInsideRect({
                            x: t.touches[1].pageX,
                            y: t.touches[1].pageY
                        }, this.getZoomedCanvasRect()))
                    }
                }, {
                    key: "isPanLimitReached", value: function () {
                        return !(this.eventDirection == g.in && this.store.getPan().y > this.store.getMinPan().y || this.eventDirection == g.BQ && this.store.getPan().y < 0 || this.eventDirection == g.r4 && this.store.getPan().x > this.store.getMinPan().y || this.eventDirection == g.MJ && this.store.getPan().x < 0)
                    }
                }, {
                    key: "updateStickyTooltipsConfig", value: function () {
            ...
            yt = function () {
                ...
                return (0, dt.Z)(t, [{
                    ...
                    key: "insertUI", value: function () {
                        this.store.state.fullscreen.enable_fullscreen_mode && (this.store.state.object_list.enable_object_list && "on-top" === this.store.state.object_list.menu_style && "right" === this.store.state.object_list.menu_position ? this.store.getUIWrap().querySelector(".imp-ui-bottom-left").appendChild(this.button.element) : this.store.getUIWrap().querySelector(".imp-ui-bottom-right").appendChild(this.button.element))
                    }
                }, {
                    key: "goFullscreen", value: function () {
                        var t, e = this, n = (0, m.ZB)({}, this.store.state);
                    ...
                    key: "closeFullscreen", value: function () {
                        var t;
                        this.store.getIsFullscreen() && (this.store.getEventController().removeEvents(), this.store.getMenuController().removeMenu(), this.store.getTooltipController().container.remove(), document.body.classList.remove("imp-fullscreen-mode"), null === (t = document.querySelector("#imp-fullscreen-container")) || void 0 === t || t.remove(), this.closeFullscreenCallback())
                    }
                }]), t
            }(), wt = function () {
                function t(e) {
                    (0, pt.Z)(this, t), mt(this, "store", void 0), mt(this, "image", void 0), mt(this, "element", void 0), mt(this, "window", {
                        width: 0,
                        height: 0
                    }), mt(this, "ratio", 1), this.store = e, this.element = (0, m.Bv)(this.html()), this.image = this.element.querySelector(".imp-ui-navigator-window-image")
                }
                ...
                function t(e) {
                    (0, pt.Z)(this, t), mt(this, "store", void 0), mt(this, "navigator", void 0), mt(this, "ix", 0), mt(this, "iy", 0), this.store = e, this.store.state.zooming.enable_zooming && this.store.state.zooming.enable_navigator ? (this.store.subscribe(this.handleAction.bind(this)), this.createUI()) : this.navigator = {
                ...
                return (0, dt.Z)(t, [{
                    ...
                    key: "insertUI", value: function () {
                        this.store.state.zooming.enable_zooming && this.store.state.zooming.enable_navigator && (this.store.state.object_list.enable_object_list && "on-top" === this.store.state.object_list.menu_style && "left" === this.store.state.object_list.menu_position ? this.store.getUIWrap().querySelector(".imp-ui-bottom-right").appendChild(this.navigator.element) : this.store.getUIWrap().querySelector(".imp-ui-bottom-left").appendChild(this.navigator.element), this.navigator.adjustSize())
                    }
                }, {
                    key: "handleAction", value: function (t) {
                        var e = this;
                        "resize" == t.type && requestAnimationFrame((function () {
                            requestAnimationFrame((function () {
                                e.navigator.adjustSize(), e.navigator.redraw()
                            }))
                        })), "panOnNavigator" == t.type && this.pan({
                            x: t.payload.x,
                            y: t.payload.y
                        }), "zoomUpdate" == t.type && this.navigator.redraw()
                    }
                }, {
                    key: "pan", value: function (t) {
                        var e = t.x, n = t.y,
            ...
            }(), kt = __webpack_require__(971), jt = __webpack_require__(144), Mt = {
                version: "6.0.15",
                id: 0,
                ...
                tooltips: {
                    ...
                    fullscreen_background_opacity: .75
                },
                zooming: {
                    enable_zooming: !1,
                    max_zoom: 4,
                ...
                return (0, dt.Z)(t, [{
                    ...
                    key: "html", value: function () {
                        return "<".concat(this.options.heading, ' style="').concat(this.css(), " ").concat(this.options.other.css, '" id="').concat(this.options.other.id, '" class="').concat(this.options.other.classes, '">').concat(this.options.text, "</").concat(this.options.heading, ">")
                    }
                }]), t
            }(), Pt = function () {
                function t(e) {
                ...
                return (0, dt.Z)(t, [{
                    ...
                    key: "isValidHttpUrl", value: function (t) {
                        var e;
                        try {
                            e = new URL(t)
                        } catch (t) {
        ...
        var Rt = function () {
            ...
            function t(e) {
                var n = e.style, o = e.content, i = e.animation, r = e.id;
                (0, pt.Z)(this, t), this.id = r, this.style = n, this.content = new Rt(o), this.animation = i
            }

            return (0, dt.Z)(t, [{
                key: "css", value: function () {
                    var t = "", e = (0, m.oo)(this.style.background_color) || {r: 0, b: 0, g: 0};
                    return t += "border-radius: ".concat(this.style.border_radius, "px;"), t += "padding: ".concat(this.style.padding, "px;"), t += "background: rgba(".concat(e.r, ", ").concat(e.g, ", ").concat(e.b, ", ").concat(this.style.background_opacity, ");"), this.style.auto_width || (t += "width: ".concat(this.style.width, "px;")), t
                }
            }, {
                key: "html", value: function () {
                    var t = "", e = (0, m.oo)(this.style.background_color) || {r: 0, b: 0, g: 0};
                    return t += '<div class="imp-tooltip-wrap imp-tooltip-position-'.concat(this.style.position, '">'), t += '<div class="imp-tooltip" style="'.concat(this.css(), '" data-tooltip-id="').concat(this.id, '">'), "top" === this.style.position && (t += '<div class="hs-arrow hs-arrow-bottom" style="border-top-color: rgba('.concat(e.r, ", ").concat(e.g, ", ").concat(e.b, ", ").concat(this.style.background_opacity, ');"></div>')), "bottom" === this.style.position && (t += '<div class="hs-arrow hs-arrow-top" style="border-bottom-color: rgba('.concat(e.r, ", ").concat(e.g, ", ").concat(e.b, ", ").concat(this.style.background_opacity, ');"></div>')), "left" === this.style.position && (t += '<div class="hs-arrow hs-arrow-right" style="border-left-color: rgba('.concat(e.r, ", ").concat(e.g, ", ").concat(e.b, ", ").concat(this.style.background_opacity, ');"></div>')), "right" === this.style.position && (t += '<div class="hs-arrow hs-arrow-left" style="border-right-color: rgba('.concat(e.r, ", ").concat(e.g, ", ").concat(e.b, ", ").concat(this.style.background_opacity, ');"></div>')), t += '<div class="imp-tooltip-content">'.concat(this.content.html(), "</div>"), t += "</div>", t += "</div>"
                }
            }]), t
        }(), Bt = function () {
            function t(e) {
        ...
        var Wt = function () {
            function t(e) {
                (0, pt.Z)(this, t), mt(this, "store", void 0), mt(this, "tooltipsAreFullscreen", !1), mt(this, "container", document.createElement("div")), mt(this, "mouseCoords", {
                    x: 0,
                    y: 0
                }), mt(this, "tooltips", []), mt(this, "openedTooltips", new Set), mt(this, "stickyTooltips", void 0), mt(this, "tooltipElements", {}), mt(this, "tooltipAnimationTimeouts", {}), mt(this, "bodyOverflow", void 0), this.store = e, this.store.state.tooltips.enable_tooltips && (this.store.subscribe(this.handleAction.bind(this)), this.stickyTooltips = this.store.state.tooltips.sticky_tooltips, (0, m.tq)() && (this.stickyTooltips = !1), (0, m.tq)() && this.disableStickyTooltips(), ("always" === this.store.state.tooltips.fullscreen_tooltips || "mobile-only" === this.store.state.tooltips.fullscreen_tooltips && (0, m.tq)()) && (this.tooltipsAreFullscreen = !0), this.setupContainer(), this.createTooltips())
            }

            var e;
            return (0, dt.Z)(t, [{
                key: "handleAction", value: (e = y(w().mark((function t(e) {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                ...
                key: "disableStickyTooltips", value: function () {
                    this.stickyTooltips = !1
                }
            }, {
                key: "resetStickyTooltips", value: function () {
                    (0, m.tq)() || (this.stickyTooltips = this.store.state.tooltips.sticky_tooltips)
                }
            }, {
                key: "setupContainer", value: function () {
                    var t;
                    if (null === (t = document.querySelectorAll('.imp-tooltips-container[data-image-map-id="'.concat(this.store.getID(), '"]'))) || void 0 === t || t.forEach((function (t) {
                        return t.remove()
                    })), this.container.classList.add("imp-tooltips-container"), this.container.dataset.imageMapId = this.store.getID(), this.tooltipsAreFullscreen) {
                ...
                key: "createTooltips", value: function () {
                    var t, e = "", n = Ft(this.store.getObjects());
                    try {
                        for (n.s(); !(t = n.n()).done;) {
                            var o = t.value;
                            if (o.parent && (o = this.store.getObject({id: o.parent})), o.tooltip.enable_tooltip && o.type !== jt.tk) {
                                var i = void 0;
                                i = this.tooltipsAreFullscreen ? new Bt({
                ...
                key: "getTooltipElement", value: function (t) {
                ...
                key: "showTooltip", value: function (t) {
                    var e = this;
                    if (window.startchanging, t = this.store.getObject({id: t}).parent || t, this.getTooltipElement(t) && this.store.getObject({id: t})) return new Promise(function () {
                        var n = y(w().mark((function n(o) {
                            var i, r;
                ...
                key: "hideTooltip", value: function (t) {
                    var e = this;
                    return t = this.store.getObject({id: t}).parent || t, new Promise((function (n) {
                        e.store.getObject({id: t}).type !== jt.tk && e.openedTooltips.has(t) ? (e.openedTooltips.delete(t), "mobile-only" === e.store.state.tooltips.fullscreen_tooltips && (0, m.tq)() || "always" === e.store.state.tooltips.fullscreen_tooltips ? (e.animateFullscreenTooltipOut(t), requestAnimationFrame(n)) : (e.animateTooltipOut(t), requestAnimationFrame(n)), ImageMapPro.trigger({
                            type: g.x_,
                            payload: {map: e.store.state.general.name, object: e.store.getObject({id: t}).title}
                        })) : n()
                    }))
                }
            }, {
                key: "hideAllTooltips", value: function () {
                    var t = this;
                    return new Promise((function (e) {
                ...
                key: "animateTooltipIn", value: function (t) {
                    var e = this.getTooltipElement(t);
                    if (!this.store.state.tooltips.sticky_tooltips) return "grow" === this.store.state.tooltips.tooltip_animation ? (e.style.transitionProperty = "none", e.style.transform = "scale(0, 0)", e.style.opacity = 1, clearTimeout(this.tooltipAnimationTimeouts[t]), void (this.tooltipAnimationTimeouts[t] = requestAnimationFrame((function () {
                        e.style.transitionProperty = "transform", e.style.transform = "scale(1, 1)"
                    })))) : "fade" === this.store.state.tooltips.tooltip_animation ? (e.style.transitionProperty = "none", e.style.opacity = 0, clearTimeout(this.tooltipAnimationTimeouts[t]), void (this.tooltipAnimationTimeouts[t] = requestAnimationFrame((function () {
                        e.style.transitionProperty = "opacity", e.style.opacity = 1
                    })))) : void (e.style.opacity = 1);
                    e.style.opacity = 1
                }
            }, {
                key: "animateTooltipOut", value: function (t) {
                    var e = this.getTooltipElement(t);
                    return e.querySelectorAll("video").forEach((function (t) {
                        t.dispatchEvent(new Event("pause"))
                    })), e.querySelectorAll("iframe").forEach((function (t) {
                        t.setAttribute("src", t.getAttribute("src"))
                    })), this.store.state.tooltips.sticky_tooltips ? (e.style.opacity = 0, void (e.style.display = "none")) : "grow" === this.store.state.tooltips.tooltip_animation ? (e.style.transform = "scale(0, 0)", clearTimeout(this.tooltipAnimationTimeouts[t]), void (this.tooltipAnimationTimeouts[t] = setTimeout((function () {
                        e.style.opacity = 0, e.style.display = "none"
                    }), 200))) : (this.store.state.tooltips.tooltip_animation, e.style.opacity = 0, void (e.style.display = "none"))
                }
            }, {
                key: "animateFullscreenTooltipIn", value: function (t) {
                    this.container.style.display = "block", this.container.style.opacity = 1;
                    var e = this.getTooltipElement(t);
                    e.style.display = "flex", e.style.opacity = 0, e.style.transform = "scale(0.33)", requestAnimationFrame((function () {
                ...
                key: "animateFullscreenTooltipOut", value: function (t) {
                    var e = this;
                    this.container.style.opacity = 0, clearTimeout(this.tooltipAnimationTimeouts[t + "-container"]), this.tooltipAnimationTimeouts[t + "-container"] = setTimeout((function () {
                        e.container.style.display = "none"
                    }), 350);
                    var n = this.getTooltipElement(t);
                    n.style.opacity = 0, n.style.transform = "scale(0.33)", clearTimeout(this.tooltipAnimationTimeouts[t]), this.tooltipAnimationTimeouts[t] = setTimeout((function () {
                        n.style.display = "none"
                    }), 350), n.querySelectorAll("video").forEach((function (t) {
                        t.dispatchEvent(new Event("pause"))
                ...
                key: "isPointInsideVisibleTooltip", value: function (t) {
                    var e = t.x, n = t.y;
                    if (this.tooltipsAreFullscreen && this.openedTooltips.size > 0) return !0;
                    var o, i = Ft(this.openedTooltips);
                    try {
                        for (i.s(); !(o = i.n()).done;) {
                            var r = o.value, a = this.createPolysForTooltip(r);
                ...
                key: "createPolysForTooltip", value: function (t) {
                    t = this.store.getObject({id: t}).parent || t;
                    var e = this.store.getObjectController().objects[t].getBoundingClientRect(),
                        n = e.x + window.scrollX + e.width / 2, o = e.y + window.scrollY + e.height / 2,
                        i = (0, m.Yo)(this.getTooltipElement(t)), r = i.offset.left, a = i.offset.top,
                        s = i.offsetWidth, c = i.offsetHeight, l = [], u = [];
                    return "top" === this.store.getObject({id: t}).tooltip_style.position && (l = [[r, a], [r + s, a], [r + s, a + c], [r + s / 2, o], [r, a + c]], u = [[r, a], [r + s, a], [r + s, a + c], [r, a + c]]), "bottom" === this.store.getObject({id: t}).tooltip_style.position && (l = [[r, a], [r + s / 2, o], [r + s, a], [r + s, a + c], [r, a + c]], u = [[r, a], [r + s, a], [r + s, a + c], [r, a + c]]), "left" === this.store.getObject({id: t}).tooltip_style.position && (l = [[r, a], [r + s, a], [n, a + c / 2], [r + s, a + c], [r, a + c]], u = [[r, a], [r + s, a], [r + s, a + c], [r, a + c]]), "right" === this.store.getObject({id: t}).tooltip_style.position && (l = [[r, a], [r + s, a], [r + s, a + c], [r, a + c], [n, a + c / 2]], u = [[r, a], [r + s, a], [r + s, a + c], [r, a + c]]), {
                        poly: l,
                        polyTooltipOnly: u
                    }
                }
            }, {
                key: "getObjectVisibleRect", value: function (t) {
                    if (this.store.getObjectController().objects[t]) {
                        var e, n, o, i, r = this.store.getObject({id: t}),
                            a = this.store.getObjectController().objects[t].getRect(), s = window.innerWidth,
                            c = window.innerHeight;
                        if (this.stickyTooltips ? (e = this.store.getEventCoordinates().x - this.store.getCanvasWrapRect().offset.left, n = this.store.getEventCoordinates().y - this.store.getCanvasWrapRect().offset.top, o = 0, i = 0) : (o = a.width / 100 * this.store.getCanvasWrapRect().width, i = a.height / 100 * this.store.getCanvasWrapRect().height, o *= this.store.getZoom(), i *= this.store.getZoom(), e = a.x / 100 * this.store.getCanvasWrapRect().width, n = a.y / 100 * this.store.getCanvasWrapRect().height, e = e * this.store.getZoom() + this.store.getPan().x, n = n * this.store.getZoom() + this.store.getPan().y), r.type === jt.dv && this.store.state.objectConfig.scale_spots) {
                            var l = o / this.store.getZoom(), u = i / this.store.getZoom();
                        ...
                        } else e < 0 && (o += e, e = 0), e + o > this.store.getCanvasWrapRect().width && (o = this.store.getCanvasWrapRect().width - e), n < 0 && (i += n, n = 0), n + i > this.store.getCanvasWrapRect().height && (i = this.store.getCanvasWrapRect().height - n);
            ...
            function t(e) {
                (0, pt.Z)(this, t), mt(this, "store", void 0), mt(this, "mac", navigator.platform.toUpperCase().indexOf("MAC") >= 0), mt(this, "buttons", void 0), mt(this, "scrollMessage", void 0), mt(this, "currentZoom", 1), mt(this, "targetZoom", 1), mt(this, "maxZoom", 4), mt(this, "zoomMultiplier", 1.45), mt(this, "ix", 0), mt(this, "iy", 0), mt(this, "lastX", 0), mt(this, "lastY", 0), mt(this, "targetPanX", 0), mt(this, "targetPanY", 0), mt(this, "actualPanX", 0), mt(this, "actualPanY", 0), mt(this, "initialPanX", 0), mt(this, "initialPanY", 0), mt(this, "panDeltaX", 0), mt(this, "panDeltaY", 0), mt(this, "minPanX", 0), mt(this, "minPanY", 0), mt(this, "pinchInitial", [{
                    ...
                    x: 0,
                    y: 0
                }]), mt(this, "pinchInitialDistance", 0), mt(this, "pinchInitialZoom", 0), mt(this, "showTimeout", void 0), mt(this, "hideStartTimeout", void 0), mt(this, "hideEndTimeout", void 0), this.store = e, this.setMaxZoom(), this.store.state.zooming.enable_zooming && (this.store.subscribe(this.handleAction.bind(this)), this.store.state.zooming.enable_zoom_buttons && this.createButtons(), this.store.state.zooming.hold_ctrl_to_zoom && this.createScrollMessage())
            }

            return (0, dt.Z)(t, [{
                key: "handleAction", value: function (t) {
                    "failedToZoom" == t.type && this.displayScrollMessage(), "panTo" == t.type && this.setTargetPan({
                        x: t.payload.x,
                        y: t.payload.y
                    }), "startPan" == t.type && this.startPan({
                        x: t.payload.x,
                        y: t.payload.y
                    }), "pan" == t.type && this.pan({
                        x: t.payload.x,
                        y: t.payload.y
                    }), "startPinch" == t.type && this.startPinch(t.payload.event), "pinch" == t.type && this.pinch(t.payload.event), t.type, "resize" == t.type && this.resetZoom(!0)
                }
            }, {
                ...
                key: "insertUI", value: function () {
                    this.store.state.zooming.enable_zooming && this.store.state.zooming.enable_zoom_buttons && (this.store.state.object_list.enable_object_list && "on-top" === this.store.state.object_list.menu_style && "right" === this.store.state.object_list.menu_position ? (this.store.getUIWrap().querySelector(".imp-ui-bottom-left").appendChild(this.buttons.zoomInButton), this.store.getUIWrap().querySelector(".imp-ui-bottom-left").appendChild(this.buttons.zoomOutButton)) : (this.store.getUIWrap().querySelector(".imp-ui-bottom-right").appendChild(this.buttons.zoomInButton), this.store.getUIWrap().querySelector(".imp-ui-bottom-right").appendChild(this.buttons.zoomOutButton)))
                }
            }, {
                key: "createScrollMessage", value: function () {
                    var t = "CTRL";
                    this.mac && (t = "⌘");
                    var e = "";
                    e += '<div class="imp-ui-scroll-message-wrap">', e += '   <div class="imp-ui-scroll-message-wrap-inner">', e += '       <div class="imp-ui-scroll-message">Hold <div class="imp-ui-scroll-message-button">'.concat(t, "</div> to Zoom</div>"), e += "   </div>", e += "</div>", this.scrollMessage = (0, m.Bv)(e), this.store.getUIWrap().appendChild(this.scrollMessage)
                }
            }, {
                key: "displayScrollMessage", value: function () {
                    var t = this;
                    this.scrollMessage.style.display = "block", clearTimeout(this.showTimeout), clearTimeout(this.hideStartTimeout), clearTimeout(this.hideEndTimeout), this.showTimeout = setTimeout((function () {
                        t.scrollMessage.classList.add("imp-visible"), t.hideStartTimeout = setTimeout((function () {
                            t.scrollMessage.classList.remove("imp-visible"), t.hideEndTimeout = setTimeout((function () {
                ...
                key: "resetZoom", value: function (t) {
                ...
                key: "zoomIn", value: function (t) {
                    var e = t.coords, n = t.animate, o = void 0 === n || n, i = t.targetZoom;
                    if (this.targetZoom < this.maxZoom) {
                        var r = i || this.currentZoom * this.zoomMultiplier, a = 0, s = 0;
                        e ? (a = e.x, s = e.y) : (a = this.store.getCanvasWrapRect().offset.left + this.store.getCanvasWrapRect().width / 2, s = this.store.getCanvasWrapRect().offset.top + this.store.getCanvasWrapRect().height / 2), this.setTargetZoom({
                            zoom: r,
                            focalPointX: a,
                            focalPointY: s,
                            animate: o
                ...
                key: "zoomOut", value: function (t) {
                    var e = t.coords, n = t.animate;
                    if (this.targetZoom > 1) {
                        var o = this.currentZoom / this.zoomMultiplier, i = 0, r = 0;
                        e ? (i = e.x, r = e.y) : (i = this.store.getCanvasWrapRect().offset.left + this.store.getCanvasWrapRect().width / 2, r = this.store.getCanvasWrapRect().offset.top + this.store.getCanvasWrapRect().height / 2), this.setTargetZoom({
                            zoom: o,
                            focalPointX: i,
                            focalPointY: r,
                            animate: n
                ...
                key: "startPinch", value: function (t) {
                    this.pinchInitial[0] = {
                        x: t.touches[0].pageX,
                        y: t.touches[0].pageY
                    }, this.pinchInitial[1] = {
                        x: t.touches[1].pageX,
                        y: t.touches[1].pageY
                    }, this.initialPanX = this.actualPanX, this.initialPanY = this.actualPanY, this.ix = (t.touches[0].pageX + t.touches[1].pageX) / 2, this.iy = (t.touches[0].pageY + t.touches[1].pageY) / 2, this.lastX = this.ix, this.lastY = this.iy, this.pinchInitialDistance = Math.sqrt(Math.pow(this.pinchInitial[1].x - this.pinchInitial[0].x, 2) + Math.pow(this.pinchInitial[1].y - this.pinchInitial[0].y, 2)), this.pinchInitialZoom = this.currentZoom
                }
            }, {
                ...
                key: "setTargetPan", value: function (t) {
                    var e = t.x, n = t.y, o = t.redraw, i = void 0 === o || o,
                ...
                key: "setTargetZoom", value: function (t) {
                    var e = t.zoom, n = t.focalPointX, o = t.focalPointY, i = t.animate, r = void 0 === i || i,
                        a = t.redraw, s = void 0 === a || a;
                    this.targetPanX = this.actualPanX, this.targetPanY = this.actualPanY, this.targetZoom = e, this.targetZoom > this.maxZoom && (this.targetZoom = this.maxZoom), this.targetZoom < 1 && (this.targetZoom = 1);
                    ...
                    if (n && o) {
                        var u = (0, m.Yo)(this.store.getScaleWrap()), p = n - u.offset.left, d = o - u.offset.top,
                ...
                key: "redraw", value: function (t) {
                    var e = this, n = t.animate, o = void 0 !== n && n;
                ...
                key: "setMaxZoom", value: function () {
                    this.store.state.zooming.enable_zooming || (this.maxZoom = 1), this.store.getImage() && this.store.state.zooming.limit_max_zoom_to_image_size ? this.maxZoom = this.store.getImage().naturalWidth / this.store.getCanvasWrapRect().width : this.maxZoom = this.store.state.zooming.max_zoom, this.maxZoom < 1 && (this.maxZoom = 1)
                }
            }, {
                key: "limit", value: function () {
                    this.minPanX = this.store.getCanvasWrapRect().width - this.store.getCanvasWrapRect().width * this.targetZoom, this.minPanY = this.store.getCanvasWrapRect().height - this.store.getCanvasWrapRect().height * this.targetZoom, this.targetPanX > 0 && (this.targetPanX = 0), this.targetPanY > 0 && (this.targetPanY = 0), this.targetPanX < this.minPanX && (this.targetPanX = this.minPanX), this.targetPanY < this.minPanY && (this.targetPanY = this.minPanY)
                }
            }, {
                key: "interpolate", value: function (t) {
                    t ? (this.currentZoom = (0, m.t7)(this.currentZoom, this.targetZoom, .1), this.actualPanX = (0, m.t7)(this.actualPanX, this.targetPanX, .1), this.actualPanY = (0, m.t7)(this.actualPanY, this.targetPanY, .1), Math.abs(this.currentZoom - this.targetZoom) < .001 && (this.currentZoom = this.targetZoom), Math.abs(this.actualPanX - this.targetPanX) < 1 && (this.actualPanX = this.targetPanX), Math.abs(this.actualPanY - this.targetPanY) < 1 && (this.actualPanY = this.targetPanY)) : (this.currentZoom = this.targetZoom, this.actualPanX = this.targetPanX, this.actualPanY = this.targetPanY)
                }
            }, {
            ...
            function t() {
                var e = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 250;
                (0, pt.Z)(this, t), mt(this, "cacheTTL", 250), mt(this, "invalidateCacheInterval", void 0), mt(this, "cache", {}), this.cacheTTL = n, this.invalidateCacheInterval = setInterval((function () {
                    e.cache = {}
                }), this.cacheTTL)
            }
        ...
        var Xt = function () {
            ...
            return (0, dt.Z)(t, [{
                ...
                key: "selectArtboard", value: function (t) {
            ...
            return (0, dt.Z)(t, [{
                ...
                key: "openFolder", value: function () {
                    this.iconElement.innerHTML = '<svg class="imp-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">\x3c!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --\x3e<path d="M137.4 374.6c12.5 12.5 32.8 12.5 45.3 0l128-128c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L32 192c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l128 128z"/></svg>'
                }
            }, {
                key: "closeFolder", value: function () {
                    this.iconElement.innerHTML = '<svg class="imp-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">\x3c!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --\x3e<path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/></svg>'
                }
            }, {
                key: "redraw", value: function () {
            ...
            function t(e) {
                var n = e.options, o = e.imageMapId;
                (0, pt.Z)(this, t), mt(this, "element", document.createElement("div")), mt(this, "options", void 0), this.options = n, this.element.classList.add("imp-object-list-item-artboard"), this.element.dataset.listItemId = this.options.id, this.element.dataset.imageMapId = o;
        ...
        var te = function () {
            function t(e) {
                (0, pt.Z)(this, t), mt(this, "store", void 0), mt(this, "element", document.createElement("div")), mt(this, "items", []), mt(this, "parentsForItem", {}), mt(this, "height", 0), mt(this, "hiddenGroups", new Set), mt(this, "hiddenArtboards", new Set), mt(this, "artboardItems", {}), this.store = e, this.element.classList.add("imp-object-list"), this.drawItems()
            }

            return (0, dt.Z)(t, [{
                key: "drawItems", value: function () {
                    var t = this;
                    this.element.innerHTML = "";
                    var e, n = Jt(this.store.getArtboards());
                    try {
                        var o = function () {
                            var n, o = e.value;
                            ...
                            })), (n = t.items).push.apply(n, a), a.forEach((function (t) {
                ...
                key: "createArtboardContainer", value: function () {
                    var t = document.createElement("div");
                    return t.classList.add("imp-object-list-artboard-container"), t
                }
            }, {
                key: "createItemAndChildren", value: function (t) {
                    ...
                    var i = 0;
                    if (this.store.state.object_list.show_groups && (i = e.length - 1), (t.type !== jt.WW || t.type === jt.WW && this.store.state.object_list.show_groups || t.type === jt.WW && t.single_object) && n.push(new $t({
                        options: t,
                        isGroup: o,
                        depth: i,
                        imageMapId: this.store.getID()
                    })), t.type === jt.WW && !t.single_object) {
                        var r, a = Jt(t.children);
                        try {
                            for (a.s(); !(r = a.n()).done;) {
                                var s = r.value;
                ...
                key: "filterItems", value: function () {
                    var t, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", n = Jt(this.items);
                    try {
                        for (n.s(); !(t = n.n()).done;) {
                            var o = t.value;
                            if (e.length > 2) {
                ...
                key: "toggleGroup", value: function (t) {
                    this.hiddenGroups.has(t) ? (this.hiddenGroups.delete(t), this.items.filter((function (e) {
                        return e.options.id === t
                    }))[0].openFolder()) : (this.hiddenGroups.add(t), this.items.filter((function (e) {
                        return e.options.id === t
                    }))[0].closeFolder()), this.render()
                }
            }, {
                key: "toggleArtboard", value: function (t) {
                ...
                key: "render", value: function () {
                    var t, e = Jt(this.items);
                    try {
                        for (e.s(); !(t = e.n()).done;) {
                            var n, o = t.value, i = !1, r = Jt(this.parentsForItem[o.options.id]);
                            try {
                                for (r.s(); !(n = r.n()).done;) {
                                    var a = n.value;
            ...
            function t(e) {
                (0, pt.Z)(this, t), mt(this, "store", void 0), mt(this, "menu", void 0), mt(this, "openButton", void 0), mt(this, "closeButton", void 0), this.store = e, this.store.state.object_list.enable_object_list && (this.store.subscribe(this.handleAction.bind(this)), this.menu = new ne(this.store), this.openButton = new oe, this.closeButton = new ie, this.menu.element.dataset.imageMapId = this.store.getID(), this.menu.element.appendChild(this.closeButton.element), this.setMenuHeight())
            }

            return (0, dt.Z)(t, [{
                key: "insertMenu", value: function () {
                    this.store.state.object_list.enable_object_list && ("detached" !== this.store.state.object_list.menu_style ? this.store.getIsMenuMobile() ? this.appendMobileMenu() : this.appendRegularMenu() : this.appendDetachedMenu())
                }
            }, {
                key: "removeMenu", value: function () {
                ...
                key: "handleAction", value: function (t) {
                    ...
                    })), "updateSearch" == t.type && (this.menu.search.redraw(), this.menu.list.filterItems(t.payload.searchString)), "clearSearch" == t.type && (this.menu.search.clear(), this.menu.search.redraw(), this.menu.list.filterItems()), "openMenu" == t.type && this.showMobileMenu(), "closeMenu" == t.type && this.hideMobileMenu(), "closeFullscreen" == t.type && this.store.getIsFullscreen() && this.removeMenu()
                }
            }, {
                key: "appendDetachedMenu", value: function () {
                    var t;
                    null === (t = document.querySelector('[data-imp-detached-menu="' + this.store.state.general.name + '"]')) || void 0 === t || t.appendChild(this.menu.element), this.menu.element.classList.add("imp-loaded"), this.menu.element.classList.add("imp-detached")
                }
            }, {
                key: "appendMobileMenu", value: function () {
                ...
                key: "appendRegularMenu", value: function () {
                ...
                key: "showMobileMenu", value: function () {
                    this.store.state.object_list.enable_object_list && this.menu.element.classList.add("imp-active")
                }
            }, {
                key: "hideMobileMenu", value: function () {
                    this.store.state.object_list.enable_object_list && this.menu.element.classList.remove("imp-active")
                }
            }, {
                key: "setListOverflow", value: function () {
                    var t = 0;
                    this.store.state.object_list.enable_search && (t = 71), this.menu.list.height > this.getMenuHeight() - t ? this.menu.list.element.style.overflowY = "scroll" : this.menu.list.element.style.overflowY = "auto"
                }
            }, {
                key: "setMenuHeight", value: function () {
                    "default" === this.store.state.object_list.menu_style || this.store.getIsMenuMobile() ? this.menu.element.style.height = this.getMenuHeight() + "px" : this.menu.element.style.maxHeight = this.getMenuHeight() + "px"
                }
            }, {
                key: "getMenuHeight", value: function () {
        ...
        const ce = {
            getImageMap: function () {
                ...
                var n, o = e.id;
                return le(t.artboards, (function (t) {
                ...
                var t = [];
                return le([this.getArtboard()], (function (e) {
                ...
                var n, o, i = e.id, r = ae(t.artboards);
                try {
                    var a = function () {
                        var t = o.value;
                        le([t], (function (e) {
                ...
                var n = e.id, o = this.getObject({id: n}), i = [];
                return le(o.children, (function (t) {
                    i.push(t)
                })), i
                ...
                if (t && !this.imageMap.cacheController.getValue(g.db)) {
                    var e = this.imageMap.tooltipController.getTooltipElement(t), n = (0, m.Yo)(e);
        ...
        const ue = {
            beforeResize: function (t) {
                ...
                t.commit, t.state;
                var n = t.store, o = e.coords, i = e.animate, r = void 0 === i || i, a = e.targetZoom;
                return new Promise(function () {
                    var t = y(w().mark((function t(e) {
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 2, n.getZoomController().zoomIn({
                                        coords: o,
                                        animate: r,
                                        targetZoom: a
                                    });
                ...
                t.commit, t.state;
                var n = t.store, o = e.coords, i = e.animate, r = void 0 === i || i;
                return new Promise(function () {
                    var t = y(w().mark((function t(e) {
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                ...
                t.commit, t.state;
                var n = t.store, o = e.objectId, i = e.showTooltip, r = void 0 === i || i, a = e.hideAllTooltips,
                    s = void 0 === a || a;
                return new Promise(function () {
                    var t = y(w().mark((function t(e) {
                        return w().wrap((function (t) {
                ...
                t.commit;
                var n = t.state, o = t.store, i = e.objectId, r = e.showTooltip, a = void 0 !== r && r;
                return new Promise((function (t) {
                    if (n.zooming.enable_zooming) {
                        var e = o.getObjectController().getFocusObjectCoordsAndZoom(i);
                        o.getZoomController().setTargetZoom({
                            zoom: e.zoom,
                            redraw: !1
                        }), o.getZoomController().setTargetPan({
                            x: e.pan.x,
                            y: e.pan.y
                        }), o.getMenuController().hideMobileMenu(), requestAnimationFrame(y(w().mark((function e() {
                ...
                t.commit, t.state, t.store
            }, changeArtboard: (pe = y(w().mark((function t(e, n) {
                var o, i, r, a, s;
                return w().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                            return e.commit, o = e.state, i = e.store, r = n.artboardId, a = n.zoomOut, s = void 0 !== a && a, t.abrupt("return", new Promise(function () {
                                var t = y(w().mark((function t(e) {
                                    return w().wrap((function (t) {
                                        for (; ;) switch (t.prev = t.next) {
                                            case 0:
                ...
                t.commit, t.state;
                var n = t.store;
                return e.objectIds, new Promise(function () {
                    var t = y(w().mark((function t(e) {
                        return w().wrap((function (t) {
                            for (; ;) switch (t.prev = t.next) {
                                case 0:
        ...
        var pe;
        const de = {
            setExampleMutation: function (t, e) {
            }
        };
        ...
        var fe = function () {
            function t(e) {
                var n = e.initialState, o = e.imageMap;
                for (var i in (0, pt.Z)(this, t), mt(this, "imageMap", void 0), mt(this, "getterProxyHandler", {
                    apply: function (t, e, n) {
                        return (t = t.bind(e)).apply(void 0, [e.state].concat((0, Vt.Z)(n)))
                    }
                }), this.imageMap = o, this.setState(n), ce) this[i] = new Proxy(ce[i], this.getterProxyHandler);
            ...
            return (0, dt.Z)(t, [{
                ...
                key: "commit", value: function (t, e) {
                    de[t](this.state, e);
                    var n, o = he(this.mutationSubscribers);
                    try {
                ...
                key: "dispatch", value: (e = y(w().mark((function t(e, n) {
                    var o, i, r;
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                ...
                key: "subscribeMutation", value: function (t) {
        ...
        function ve(t) {
            var e = t;
            return "plain-text" == t.content_type && (e = function (t) {
                return [{type: "Paragraph", text: t.plain_text}]
            }(t)), t.squares_settings && (e = function (t) {
                var e, n = [], o = ge(t.squares_settings.containers);
                try {
                    for (o.s(); !(e = o.n()).done;) {
                        var i, r = e.value;
                        if (null !== (i = r.settings) && void 0 !== i && i.elements) {
                            var a, s = ge(r.settings.elements);
                            try {
                                for (s.s(); !(a = s.n()).done;) {
                                    var c, l = a.value;
                                    "Paragraph" == l.settings.name && null !== (c = l.options) && void 0 !== c && c.text && n.push(ye(l)), "Heading" == l.settings.name && n.push(_e(l)), "Image" == l.settings.name && n.push(we(l)), "Button" == l.settings.name && n.push(xe(l)), "YouTube" == l.settings.name && n.push(je(l)), "Video" == l.settings.name && n.push(ke(l))
                                }
                            } catch (t) {
                                s.e(t)
                            } finally {
        ...
        function ye(t) {
            ...
            return {
                ...
                boxModel: {
                    ...
                    height: "auto",
                    margin: {
                        top: (null === (f = t.options) || void 0 === f || null === (f = f.layout) || void 0 === f || null === (f = f.box_model) || void 0 === f || null === (f = f.margin) || void 0 === f ? void 0 : f.top) || Et.paragraph.boxModel.margin.top,
                        bottom: (null === (g = t.options) || void 0 === g || null === (g = g.layout) || void 0 === g || null === (g = g.box_model) || void 0 === g || null === (g = g.margin) || void 0 === g ? void 0 : g.bottom) || Et.paragraph.boxModel.margin.bottom,
                        left: (null === (b = t.options) || void 0 === b || null === (b = b.layout) || void 0 === b || null === (b = b.box_model) || void 0 === b || null === (b = b.margin) || void 0 === b ? void 0 : b.left) || Et.paragraph.boxModel.margin.left,
                        right: (null === (v = t.options) || void 0 === v || null === (v = v.layout) || void 0 === v || null === (v = v.box_model) || void 0 === v || null === (v = v.margin) || void 0 === v ? void 0 : v.right) || Et.paragraph.boxModel.margin.right
                    },
                    padding: {
                        top: (null === (y = t.options) || void 0 === y || null === (y = y.layout) || void 0 === y || null === (y = y.box_model) || void 0 === y || null === (y = y.padding) || void 0 === y ? void 0 : y.top) || Et.paragraph.boxModel.padding.top,
                        bottom: (null === (_ = t.options) || void 0 === _ || null === (_ = _.layout) || void 0 === _ || null === (_ = _.box_model) || void 0 === _ || null === (_ = _.padding) || void 0 === _ ? void 0 : _.bottom) || Et.paragraph.boxModel.padding.bottom,
                        left: (null === (w = t.options) || void 0 === w || null === (w = w.layout) || void 0 === w || null === (w = w.box_model) || void 0 === w || null === (w = w.padding) || void 0 === w ? void 0 : w.left) || Et.paragraph.boxModel.padding.left,
                        right: (null === (x = t.options) || void 0 === x || null === (x = x.layout) || void 0 === x || null === (x = x.box_model) || void 0 === x || null === (x = x.padding) || void 0 === x ? void 0 : x.right) || Et.paragraph.boxModel.padding.right
                    }
                }
            }
        }
        ...
        function _e(t) {
            ...
            return {
                ...
                boxModel: {
                    ...
                    height: "auto",
                    margin: {
                        top: (null === (g = t.options) || void 0 === g || null === (g = g.layout) || void 0 === g || null === (g = g.box_model) || void 0 === g || null === (g = g.margin) || void 0 === g ? void 0 : g.top) || Et.heading.boxModel.margin.top,
                        bottom: (null === (b = t.options) || void 0 === b || null === (b = b.layout) || void 0 === b || null === (b = b.box_model) || void 0 === b || null === (b = b.margin) || void 0 === b ? void 0 : b.bottom) || Et.heading.boxModel.margin.bottom,
                        left: (null === (v = t.options) || void 0 === v || null === (v = v.layout) || void 0 === v || null === (v = v.box_model) || void 0 === v || null === (v = v.margin) || void 0 === v ? void 0 : v.left) || Et.heading.boxModel.margin.left,
                        right: (null === (y = t.options) || void 0 === y || null === (y = y.layout) || void 0 === y || null === (y = y.box_model) || void 0 === y || null === (y = y.margin) || void 0 === y ? void 0 : y.right) || Et.heading.boxModel.margin.right
                    },
                    padding: {
                        top: (null === (_ = t.options) || void 0 === _ || null === (_ = _.layout) || void 0 === _ || null === (_ = _.box_model) || void 0 === _ || null === (_ = _.padding) || void 0 === _ ? void 0 : _.top) || Et.heading.boxModel.padding.top,
                        bottom: (null === (w = t.options) || void 0 === w || null === (w = w.layout) || void 0 === w || null === (w = w.box_model) || void 0 === w || null === (w = w.padding) || void 0 === w ? void 0 : w.bottom) || Et.heading.boxModel.padding.bottom,
                        left: (null === (x = t.options) || void 0 === x || null === (x = x.layout) || void 0 === x || null === (x = x.box_model) || void 0 === x || null === (x = x.padding) || void 0 === x ? void 0 : x.left) || Et.heading.boxModel.padding.left,
                        right: (null === (k = t.options) || void 0 === k || null === (k = k.layout) || void 0 === k || null === (k = k.box_model) || void 0 === k || null === (k = k.padding) || void 0 === k ? void 0 : k.right) || Et.heading.boxModel.padding.right
                    }
                }
            }
        }
        ...
        function we(t) {
            ...
            return {
                ...
                boxModel: {
                    ...
                    height: "auto",
                    margin: {
                        top: (null === (a = t.options) || void 0 === a || null === (a = a.layout) || void 0 === a || null === (a = a.box_model) || void 0 === a || null === (a = a.margin) || void 0 === a ? void 0 : a.top) || Et.image.boxModel.margin.top,
                        bottom: (null === (s = t.options) || void 0 === s || null === (s = s.layout) || void 0 === s || null === (s = s.box_model) || void 0 === s || null === (s = s.margin) || void 0 === s ? void 0 : s.bottom) || Et.image.boxModel.margin.bottom,
                        left: (null === (c = t.options) || void 0 === c || null === (c = c.layout) || void 0 === c || null === (c = c.box_model) || void 0 === c || null === (c = c.margin) || void 0 === c ? void 0 : c.left) || Et.image.boxModel.margin.left,
                        right: (null === (l = t.options) || void 0 === l || null === (l = l.layout) || void 0 === l || null === (l = l.box_model) || void 0 === l || null === (l = l.margin) || void 0 === l ? void 0 : l.right) || Et.image.boxModel.margin.right
                    },
                    padding: {
                        top: (null === (u = t.options) || void 0 === u || null === (u = u.layout) || void 0 === u || null === (u = u.box_model) || void 0 === u || null === (u = u.padding) || void 0 === u ? void 0 : u.top) || Et.image.boxModel.padding.top,
                        bottom: (null === (p = t.options) || void 0 === p || null === (p = p.layout) || void 0 === p || null === (p = p.box_model) || void 0 === p || null === (p = p.padding) || void 0 === p ? void 0 : p.bottom) || Et.image.boxModel.padding.bottom,
                        left: (null === (d = t.options) || void 0 === d || null === (d = d.layout) || void 0 === d || null === (d = d.box_model) || void 0 === d || null === (d = d.padding) || void 0 === d ? void 0 : d.left) || Et.image.boxModel.padding.left,
                        right: (null === (h = t.options) || void 0 === h || null === (h = h.layout) || void 0 === h || null === (h = h.box_model) || void 0 === h || null === (h = h.padding) || void 0 === h ? void 0 : h.right) || Et.image.boxModel.padding.right
                    }
                }
            }
        }
        ...
        function xe(t) {
            var e, n, o, i, r, a, s, c, l, u, p, d, h, m, f, g, b, v, y, _, w, x, k, j, M, I, C = {
                type: "Button",
                ...
                boxModel: {
                    ...
                    height: "auto",
                    margin: {
                        top: (null === (y = t.options) || void 0 === y || null === (y = y.layout) || void 0 === y || null === (y = y.box_model) || void 0 === y || null === (y = y.margin) || void 0 === y ? void 0 : y.top) || Et.button.boxModel.margin.top,
                        bottom: (null === (_ = t.options) || void 0 === _ || null === (_ = _.layout) || void 0 === _ || null === (_ = _.box_model) || void 0 === _ || null === (_ = _.margin) || void 0 === _ ? void 0 : _.bottom) || Et.button.boxModel.margin.bottom,
                        left: (null === (w = t.options) || void 0 === w || null === (w = w.layout) || void 0 === w || null === (w = w.box_model) || void 0 === w || null === (w = w.margin) || void 0 === w ? void 0 : w.left) || Et.button.boxModel.margin.left,
                        right: (null === (x = t.options) || void 0 === x || null === (x = x.layout) || void 0 === x || null === (x = x.box_model) || void 0 === x || null === (x = x.margin) || void 0 === x ? void 0 : x.right) || Et.button.boxModel.margin.right
                    },
                    padding: {
                        top: (null === (k = t.options) || void 0 === k || null === (k = k.layout) || void 0 === k || null === (k = k.box_model) || void 0 === k || null === (k = k.padding) || void 0 === k ? void 0 : k.top) || Et.button.boxModel.padding.top,
                        bottom: (null === (j = t.options) || void 0 === j || null === (j = j.layout) || void 0 === j || null === (j = j.box_model) || void 0 === j || null === (j = j.padding) || void 0 === j ? void 0 : j.bottom) || Et.button.boxModel.padding.bottom,
                        left: (null === (M = t.options) || void 0 === M || null === (M = M.layout) || void 0 === M || null === (M = M.box_model) || void 0 === M || null === (M = M.padding) || void 0 === M ? void 0 : M.left) || Et.button.boxModel.padding.left,
                        right: (null === (I = t.options) || void 0 === I || null === (I = I.layout) || void 0 === I || null === (I = I.box_model) || void 0 === I || null === (I = I.padding) || void 0 === I ? void 0 : I.right) || Et.button.boxModel.padding.right
                    }
                }
            };
        ...
        function ke(t) {
            ...
            return {
                ...
                boxModel: {
                    ...
                    height: "auto",
                    margin: {
                        top: (null === (p = t.options) || void 0 === p || null === (p = p.layout) || void 0 === p || null === (p = p.box_model) || void 0 === p || null === (p = p.margin) || void 0 === p ? void 0 : p.top) || Et.video.boxModel.margin.top,
                        bottom: (null === (d = t.options) || void 0 === d || null === (d = d.layout) || void 0 === d || null === (d = d.box_model) || void 0 === d || null === (d = d.margin) || void 0 === d ? void 0 : d.bottom) || Et.video.boxModel.margin.bottom,
                        left: (null === (h = t.options) || void 0 === h || null === (h = h.layout) || void 0 === h || null === (h = h.box_model) || void 0 === h || null === (h = h.margin) || void 0 === h ? void 0 : h.left) || Et.video.boxModel.margin.left,
                        right: (null === (m = t.options) || void 0 === m || null === (m = m.layout) || void 0 === m || null === (m = m.box_model) || void 0 === m || null === (m = m.margin) || void 0 === m ? void 0 : m.right) || Et.video.boxModel.margin.right
                    },
                    padding: {
                        top: (null === (f = t.options) || void 0 === f || null === (f = f.layout) || void 0 === f || null === (f = f.box_model) || void 0 === f || null === (f = f.padding) || void 0 === f ? void 0 : f.top) || Et.video.boxModel.padding.top,
                        bottom: (null === (g = t.options) || void 0 === g || null === (g = g.layout) || void 0 === g || null === (g = g.box_model) || void 0 === g || null === (g = g.padding) || void 0 === g ? void 0 : g.bottom) || Et.video.boxModel.padding.bottom,
                        left: (null === (b = t.options) || void 0 === b || null === (b = b.layout) || void 0 === b || null === (b = b.box_model) || void 0 === b || null === (b = b.padding) || void 0 === b ? void 0 : b.left) || Et.video.boxModel.padding.left,
                        right: (null === (v = t.options) || void 0 === v || null === (v = v.layout) || void 0 === v || null === (v = v.box_model) || void 0 === v || null === (v = v.padding) || void 0 === v ? void 0 : v.right) || Et.video.boxModel.padding.right
                    }
                }
            }
        }
        ...
        function je(t) {
            var e, n, o, i, r, a, s, c, l, u, p, d, h, m = Et.youtube.boxModel.width;
            0 === (null === (e = t.options) || void 0 === e || null === (e = e.youtube) || void 0 === e ? void 0 : e.iframe_auto_width) && (m = (null === (h = t.options) || void 0 === h || null === (h = h.youtube) || void 0 === h ? void 0 : h.iframe_width) || Et.youtube.boxModel.width);
            var f = {
                type: "YouTube",
                ...
                boxModel: {
                    ...
                    margin: {
                        top: (null === (r = t.options) || void 0 === r || null === (r = r.layout) || void 0 === r || null === (r = r.box_model) || void 0 === r || null === (r = r.margin) || void 0 === r ? void 0 : r.top) || Et.youtube.boxModel.margin.top,
                        bottom: (null === (a = t.options) || void 0 === a || null === (a = a.layout) || void 0 === a || null === (a = a.box_model) || void 0 === a || null === (a = a.margin) || void 0 === a ? void 0 : a.bottom) || Et.youtube.boxModel.margin.bottom,
                        left: (null === (s = t.options) || void 0 === s || null === (s = s.layout) || void 0 === s || null === (s = s.box_model) || void 0 === s || null === (s = s.margin) || void 0 === s ? void 0 : s.left) || Et.youtube.boxModel.margin.left,
                        right: (null === (c = t.options) || void 0 === c || null === (c = c.layout) || void 0 === c || null === (c = c.box_model) || void 0 === c || null === (c = c.margin) || void 0 === c ? void 0 : c.right) || Et.youtube.boxModel.margin.right
                    },
                    padding: {
                        top: (null === (l = t.options) || void 0 === l || null === (l = l.layout) || void 0 === l || null === (l = l.box_model) || void 0 === l || null === (l = l.padding) || void 0 === l ? void 0 : l.top) || Et.youtube.boxModel.padding.top,
                        bottom: (null === (u = t.options) || void 0 === u || null === (u = u.layout) || void 0 === u || null === (u = u.box_model) || void 0 === u || null === (u = u.padding) || void 0 === u ? void 0 : u.bottom) || Et.youtube.boxModel.padding.bottom,
                        left: (null === (p = t.options) || void 0 === p || null === (p = p.layout) || void 0 === p || null === (p = p.box_model) || void 0 === p || null === (p = p.padding) || void 0 === p ? void 0 : p.left) || Et.youtube.boxModel.padding.left,
                        right: (null === (d = t.options) || void 0 === d || null === (d = d.layout) || void 0 === d || null === (d = d.box_model) || void 0 === d || null === (d = d.padding) || void 0 === d ? void 0 : d.right) || Et.youtube.boxModel.padding.right
                    }
                }
            };
        ...
        var Ce = function (t) {
            ...
            if (t.spots = t.spots.reverse(), (null === (e = t.spots) || void 0 === e ? void 0 : e.length) > 0) {
                ...
                if (c) {
                    var f = {}, g = function (e) {
                        var n = m.ZB({}, Ct);
                        n.id = m.k$(), n.type = jt.WW, n.title = t.spots.filter((function (t) {
                            return t.id === e
                        }))[0].title, n.tooltip_style = t.spots.filter((function (t) {
                            return t.id === e
                        }))[0].tooltip_style, n.tooltip_content = ve(t.spots.filter((function (t) {
                            return t.id === e
                        }))[0].tooltip_content), n.single_object = !0, r[n.id] = t.spots.filter((function (t) {
                            return t.id === e
                        }))[0].layerID + "", n.children = i.filter((function (t) {
                            return c[e].includes(t.id)
                        })), f[e] = n
                    };
                    for (var b in c) g(b);
                    var v, y = [], _ = Me(t.spots);
                    try {
                        var w = function () {
                            var t = v.value;
                            return t.connected_to ? 0 : f[t.id] ? (y.push(f[t.id]), 0) : void y.push(i.filter((function (e) {
                                return e.id === t.id
                            }))[0])
                        };
            ...
            if ((null === (n = t.layers) || void 0 === n || null === (n = n.layers_list) || void 0 === n ? void 0 : n.length) > 0) {
                var x;
                o.artboards = [];
                var k, j = Me(null === (x = t.layers) || void 0 === x ? void 0 : x.layers_list);
                try {
                    var M = function () {
                        var t = k.value, e = m.ZB({}, It);
                        e.id = m.k$(), e.title = t.title, e.image_url = t.image_url, e.width = t.image_width, e.height = t.image_height, e.image_url ? e.background_type = "image" : e.background_type = "color", e.children = i.filter((function (e) {
                            return r[e.id] === t.id + ""
                        })), o.artboards.push(e)
                    };
            ...
            } else o.artboards = [m.ZB({}, It)], o.artboards[0].id = m.k$(), o.artboards[0].title = t.general.name, o.artboards[0].width = t.general.width || o.artboards[0].width, o.artboards[0].height = t.general.height || o.artboards[0].height, o.artboards[0].background_type = "image", o.artboards[0].image_url = t.image.url, o.artboards[0].children = i;
            return o.artboards.forEach((function (t) {
                Pe(t.children)
            })), o
        };
        ...
        function Ee(t, e) {
            ...
            if ("path" === i.type) {
                r.type = jt.Le;
                var a = Oe(e), s = function (t) {
                        var e = m.oo(t.default_style.stroke_color);
                        return '<path d="'.concat(t.d, '" fill="hsl(0, 100%, 50%)" stroke="rgba(').concat(e.r, ", ").concat(e.g, ", ").concat(e.b, ", ").concat(t.default_style.stroke_opacity, ')" stroke-width="').concat(t.default_style.stroke_width, 'px"></path>')
                    }(i),
                ...
                r.width = c.width / a.width * 100, r.height = c.height / a.height * 100, r.svg.html = s, r.svg.viewBox = "".concat(c.x, " ").concat(c.y, " ").concat(c.width, " ").concat(c.height), r.default_style.filters = Ae(r.default_style), r.mouseover_style.filters = Ae(r.mouseover_style)
            }
            return r
        }
        ...
        function Oe(t) {
            var e;
            if (!((null === (e = t.layers) || void 0 === e || null === (e = e.layers_list) || void 0 === e ? void 0 : e.length) > 0)) return {
                width: t.general.width,
                height: t.general.height
            };
            var n, o = Me(t.layers.layers_list);
            try {
                for (o.s(); !(n = o.n()).done;) {
                    var i = n.value;
        ...
        function Ae(t) {
            var e = m.YM("#ff0000"), n = m.YM(t.background_color);
            return [{id: m.k$(), name: "brightness", value: 1 - (e.l - n.l) / 100}, {
                id: m.k$(),
                name: "hue-rotate",
                value: n.h + "deg"
            }]
        ...
        function Pe(t) {
            var e, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function () {
                ...
                i = arguments.length > 3 ? arguments[3] : void 0, r = Me(t);
            try {
                for (r.s(); !(e = r.n()).done;) {
                    var a = e.value;
                    if (a.type !== jt.p5 && (a.parent_id = o, "" !== o ? (a.default_style.parent_filters = i.default_style.filters, a.mouseover_style.parent_filters = i.mouseover_style.filters) : (a.default_style.parent_filters = [], a.mouseover_style.parent_filters = [])), a.children) {
                        var s = a.single_object && "" === o ? a.id : o, c = a.single_object && "" === o ? a : i;
                        Pe(a.children, n, s, c)
                    }
                    if (n(a, parent)) break
                }
        ...
        function Ue(t) {
            var e = function (t) {
                ...
                var e = m.ZB({}, Mt, t);
                return e.artboards = function (t) {
                    var e = [];
                    0 === t.length && (t = [m.ZB({}, It)]);
                    var n, o = Le(t);
                    try {
                        for (o.s(); !(n = o.n()).done;) {
                            var i = n.value, r = m.ZB({}, It, i);
        ...
        var qe = function () {
            function t(e, n, o) {
                var i = this;
                (0, pt.Z)(this, t), this.id = (0, m.k$)(), this.config = Ue(n), this.launchParams = o, this.tooltipController = void 0, this.fullscreenController = void 0, this.navigatorController = void 0, this.zoomController = void 0, this.eventController = void 0, this.cacheController = void 0, this.root = void 0, this.container = void 0, this.canvasWrap = void 0, this.scaleWrap = void 0, this.translateWrap = void 0, this.UIWrap = void 0, this.image = void 0, this.background = void 0, (0, m.Cd)((function () {
            ...
            var e, n, o, i, r, a;
            return (0, dt.Z)(t, [{
                key: "init", value: (a = y(w().mark((function t() {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                return this.store = new fe({
                                    initialState: this.config,
                                    imageMap: this
                                }), this.eventController && this.eventController.removeEvents(), this.artboardController = new Kt(this.store, this.launchParams.layerID), t.next = 5, this.loadImages();
                            case 5:
                                if (t.sent) {
                                    t.next = 7;
                                    break
                ...
                key: "deinit", value: (r = y(w().mark((function t() {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                try {
                ...
                key: "handleAction", value: (i = y(w().mark((function t(e) {
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                ...
                key: "loadImages", value: (o = y(w().mark((function t() {
                    var e, n, o, i;
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                ...
                key: "adjustSize", value: (n = y(w().mark((function t() {
                    var e, n, o, i, r, a;
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                ...
                key: "updateImage", value: (e = y(w().mark((function t() {
                    var e;
                    return w().wrap((function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                ...
                key: "setBackground", value: function () {
                    this.background && this.background.remove(), this.image && this.image.remove(), "image" === this.store.getArtboard().background_type && this.store.getArtboard().image_url && this.scaleWrap.appendChild(this.image), "color" === this.store.getArtboard().background_type && (this.background || (this.background = document.createElement("div"), this.background.classList.add("imp-background")), this.background.style.background = this.store.getArtboard().background_color, this.scaleWrap.appendChild(this.background))
                }
            }, {
                key: "calculateFullscreenCanvasSize", value: function () {
                    var t, e, n = window.innerWidth, o = window.innerHeight;
                    this.store.state.object_list.enable_object_list && !this.store.getIsMenuMobile() && (n -= 240);
                    var i = n / o, r = this.store.getArtboard().width / this.store.getArtboard().height;
                    return this.store.getArtboard().use_image_size && this.image && (r = this.image.naturalWidth / this.image.naturalHeight), r < i ? (t = o * r, e = o) : (t = n, e = n / r), {
                        width: t,
                        height: e
                    }
                }
            }, {
                key: "loadCustomCode", value: function () {
        ...
        window.ImageMapPro.init = function (t, e) {
            var n, o = new qe(t, e, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : He);
            window.ImageMapPro.instances[(null === (n = e.general) || void 0 === n ? void 0 : n.name) || "Default"] = o
        }, "undefined" != typeof $ && ($.fn.imageMapPro = function (t) {
            ImageMapPro.init(this[0], t)
        });
        var Ye = void 0, Ne = void 0, Xe = void 0;
        window.debug = function (t) {
            Ye || ((Ye = document.createElement("div")).setAttribute("id", "debug"), document.querySelector("body").appendChild(Ye)), Ye.innerHTML = t, Ye.style.transitionProperty = "none", Ye.style.opacity = 1, clearInterval(Ne), clearTimeout(Xe), Xe = setTimeout((function () {
                Ne = setInterval((function () {
                    Ye.style.opacity = .75 * Ye.style.opacity, Ye.style.opacity < .1 && (Ye.style.opacity = 0, clearInterval(Ne))
                }), 50)
            }), 1e3)
